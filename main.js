...
function creerCarte(nombre, nom, description, img, rank) {
	...
	noir.appendChild(colorb);

	color.appendChild(dashed);
	color.appendChild(hb);
	color.appendChild(dashed1);

	dashed.appendChild(ha);

	dashed1.appendChild(hc);

	colora.appendChild(image);

	colorb.appendChild(p);
